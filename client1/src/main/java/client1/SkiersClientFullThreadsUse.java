...
public class SkiersClientFullThreadsUse {

  private InputParams inputParams;

  public SkiersClientFullThreadsUse(InputParams inputParams) {
  ...
  public void PostNewLiftRide() throws InterruptedException {
    ...
    // Phase 1: startup
    int numThreadsThisPhase = inputParams.getNumThreads();
    ...
    CountDownLatch latch = new CountDownLatch(numThreadsThisPhase);
