...
public class ClientController {
  ...
  public static void main(String[] args) throws InterruptedException, IOException {
    ...
    System.out.println();
    SkiersClient clientPart1 = new SkiersClient(inputParams);
    clientPart1.PostNewLiftRide();

    System.out.println();
    SkiersClientFullThreadsUse clientFullUse = new SkiersClientFullThreadsUse(inputParams);
    clientFullUse.PostNewLiftRide();
